...
const card = [
  {
    img: "/img31.png",
    title: "HP Laser 108w Printer Laser Printer, 21ppm, USB and WiFi, Compact Design",
    text: "High-quality laser printing with up to 1200x1200 dpi",
    text3: "resolution, Wi-Fi Direct, Apple AirPrint, Google Cloud Print,",
    text4: "and Mopria support for seamless wireless printing. 4ZB80A",
  ...
  return (
    <div className="p-5 md:pl-16 md:pr-16">
      ...
      <div className="h-10 flex gap-x-3 border pl-5 pt-2 border-[#e0d9e0] text-sm sm:text-base">
        ...
        <p className="text-[#c7c0c7]">Printer</p>
      </div>
      ...
      <div className="mt-5 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:w-[400px] w-full">
        ...
        <div className="lg:w-[900px] w-full">
          ...
          <p className="text-sm md:text-[14px] pt-3 border-b pb-3 border-[#e0d9e0]">
            Shop a wide selection of Laptops in UAE including 2 in 1 and
            traditional laptops at ALAM COMPUTER
          </p>
          ...
          <div className='space-y-5'>
            {card.map((product, i) => (
              <ul
                key={i}
                className="flex flex-col md:flex-row md:items-center border p-1 md:p-4 border-[#e0d9e0] pt-10 space-y-5 md:space-y-0 md:space-x-5 pb-10"
              >
